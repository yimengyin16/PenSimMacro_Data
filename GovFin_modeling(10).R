...
mod_PIT_GSP <- # cycle, HP 
df_reg_US%>% 
	lm(PIT_dlogcycle ~ GDP_dlogcycle, data = .) 
mod_PIT_GSP %>% summary

mod_PIT_GSP_H <- # cycle, Hamilton 
	df_reg_US%>% 
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H, data = .) 
mod_PIT_GSP_H %>% summary

mod_PIT_GSP_dl <- # cycle, Hamilton 
	df_reg_US%>% 
...
mod_PIT_GSPd01_H <- 
	df_reg_US %>% 
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H + GDP_dlogcycle_H:after01, data = .) 
mod_PIT_GSPd01_H %>% summary
...
mod_PIT_GSP.Lagstock_real_H <- 
	df_reg_US %>% 
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H + LagstockIdx_dlogcycle_H, data = .)
mod_PIT_GSP.Lagstock_real_H %>% summary





 # with 97 dummy for GSP and stock return
...
mod_PIT_GSPd97.Lagstockd97_real_H <- 
	df_reg_US %>% 
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H + GDP_dlogcycle_H:after97 + LagstockIdx_dlogcycle_H + LagstockIdx_dlogcycle_H:after97, data =.)
mod_PIT_GSPd97.Lagstockd97_real_H %>% summary


# with 97 dummy for stock return
...
mod_PIT_GSP.Lagstockd97_real_H <- 
	df_reg_US %>% 
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H + LagstockIdx_dlogcycle_H + LagstockIdx_dlogcycle_H:after97, data =.)
mod_PIT_GSP.Lagstockd97_real_H %>% summary
...
mod_PIT_GSP.Lagcapgain_real_H <- 
	df_reg_US %>% 
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H + Lagcapgains_dlogcycle_H, data =.)
mod_PIT_GSP.Lagcapgain_real_H %>% summary
...
mod_PIT_GSP.Lagcapgaind97_real_H <- 
	df_reg_US %>% 
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H + Lagcapgains_dlogcycle_H + Lagcapgains_dlogcycle_H:after97, data =.)
mod_PIT_GSP.Lagcapgaind97_real_H %>% summary
...
m0 <- 
	df_reg_US %>% 
	mutate(breakpoint = ifelse(year > 2001, TRUE, FALSE)) %>% 
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H + GDP_dlogcycle_H:breakpoint, data =.)
summary(m0)
...
m1 <- 
	...
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H + Lagcapgains_dlogcycle_H + Lagcapgains_dlogcycle_H:breakpoint, data =.)
summary(m1)
...
m2 <- 
	df_reg_US %>% 
	mutate(breakpoint = ifelse(year > 2001, TRUE, FALSE)) %>% 
	lm(PIT_dlogcycle_H ~ GDP_dlogcycle_H + LagstockIdx_dlogcycle_H + LagstockIdx_dlogcycle_H:breakpoint, data =.)
summary(m2)
...
# fig_salesGDP
# 
# ggsave(paste0(dir_fig_out, "fig_GovFin_salesGDP.png"), fig_salesGDP, width = 10*0.8, height = 5*0.8)
...
mod_salesgen_GSP_H <- 
	df_reg_US %>% filter(year >=1985) %>% 
	#mutate(RGSP = GDP_FRED) %>%
	lm(salesgen_dlogcycle_H ~ GDP_dlogcycle_H, data = .) 
mod_salesgen_GSP_H %>% summary
...
# Interaction between GDP and the recent two recessions
m_temp <- # with recession dummy
	df_reg_US %>% filter(state_abb == "US", year >= 1985) %>% 
	mutate(RGSP = GDP_FRED) %>%
	lm(salesgen_dlogcycle ~ GDP_dlogcycle + recession_0103:GDP_dlogcycle + recession_0810:GDP_dlogcycle , data = .) 
m_temp %>% summary
...
mod_salesselect_GSP_H <- 
	df_reg_US %>% filter(state_abb == "US", year >=1985) %>% 
	#mutate(RGSP = GDP_FRED) %>%
	lm(salessel_dlogcycle_H ~ GDP_dlogcycle_H, data = .) 
mod_salesselect_GSP_H %>% summary


# GDP with two recessions since 1985
mod_salesselect_GSPrec85_H <- 
	df_reg_US %>% filter(state_abb == "US", year >=1985) %>% 
	#mutate(RGSP = GDP_FRED) %>%
	lm(salessel_dlogcycle_H ~ GDP_dlogcycle_H + recession_0103 + recession_0810, data = .) 
mod_salesselect_GSPrec85_H %>% summary

# GDP with two recessions since 1995
mod_salesselect_GSPrec95_H <- 
	df_reg_US %>% filter(state_abb == "US", year >=1995) %>% 
	#mutate(RGSP = GDP_FRED) %>%
	lm(salessel_dlogcycle_H ~ GDP_dlogcycle_H + recession_0103 + recession_0810, data = .) 
mod_salesselect_GSPrec95_H %>% summary
...
write.xlsx2(Table_salesselect_new_param,  file = paste0(dir_fig_out, "Table_GovFin_regression_cycle_salesselect.xlsx"), sheet = "sales_param" )
write.xlsx2(Table_salesselect_new_glance, file = paste0(dir_fig_out, "Table_GovFin_regression_cycle_salesselect.xlsx"), sheet = "sales_glance", append = TRUE)
...
mod_other_GSP_H <- 
	df_reg_US %>% filter(state_abb == "US") %>% 
	mutate(RGSP = GDP_FRED) %>% 
	lm(nonPITsalestot_dlogcycle_H ~ GDP_dlogcycle_H, data = .) 
mod_other_GSP_H %>% summary
...
mod_other_GSPd_H <- 
	df_reg_US %>% filter(state_abb == "US") %>% 
	mutate(RGSP = GDP_FRED) %>%
	lm(nonPITsalestot_dlogcycle_H ~ GDP_dlogcycle_H + GDP_dlogcycle_H:after01, data = .) 
mod_other_GSPd_H  %>% 	summary
...
mod_other_GSPrecInter_H <- 
	df_reg_US %>% filter(state_abb == "US") %>% 
	mutate(RGSP = GDP_FRED) %>%
	lm(nonPITsalestot_dlogcycle_H ~ GDP_dlogcycle_H + GDP_dlogcycle_H:recession_recent2, data = .) 
mod_other_GSPrecInter_H %>%  summary
...
mod_other_GSPrecDummy_H <- 
	df_reg_US %>% filter(state_abb == "US") %>% 
	mutate(RGSP = GDP_FRED) %>%
	lm(nonPITsalestot_dlogcycle_H ~ GDP_dlogcycle_H + recession_0102 + recession_0810, data = .) 
mod_other_GSPrecDummy_H %>%  summary
...
Table_other_param <- 
	bind_rows(
		...
		mod_other_GSPrecInter       %>% tidy() %>% mutate(mod = "other_GSPrecInter"),
		mod_other_GSPrecDummy       %>% tidy() %>% mutate(mod = "other_GSPrecDummy")
	)
...
Table_other_glance <- 
	bind_rows(
		...
		mod_other_GSPrecInter       %>% glance() %>% mutate(mod = "other_GSPrecInter"),
		mod_other_GSPrecDummy       %>% glance() %>% mutate(mod = "other_GSPrecDummy")
	)


write.xlsx2(Table_other_param,  file = paste0(dir_fig_out, "Table_GovFin_regression_cycle_other.xlsx"), sheet = "other_param" )
write.xlsx2(Table_other_glance, file = paste0(dir_fig_out, "Table_GovFin_regression_cycle_other.xlsx"), sheet = "other_glance", append = TRUE)
...
mod_propertyLoc_H <- 
	df_reg_US %>% filter(state_abb == "US") %>% 
	mutate(LagGDP_dlogcycle_H  = dplyr::lag(GDP_dlogcycle_H),
				 Lag2GDP_dlogcycle_H = dplyr::lag(GDP_dlogcycle_H, 3)) %>% 
	lm(propertyLoc_dlogcycle_H ~ LagGDP_dlogcycle_H , data = .) 
mod_propertyLoc_H %>%  summary
