...
write.xlsx2(Table_PIT_param_realStock, file = paste0("policyBrief_out/",  "Table_regression_cycle_PIT.xlsx"), sheet = "PIT_param" )
write.xlsx2(Table_PIT_glance_realStock, file = paste0("policyBrief_out/", "Table_regression_cycle_PIT.xlsx"), sheet = "PIT_glance", append = TRUE)
...
write.xlsx2(Table_salesgen_new_glance, file = paste0("policyBrief_out/", "Table_regression_cycle_salesgen.xlsx"), sheet = "sales_glance", append = TRUE)
...
write.xlsx2(Table_salesselect_new_param,  file = paste0("policyBrief_out/", "Table_regression_cycle_salesselect.xlsx"), sheet = "sales_param" )
write.xlsx2(Table_salesselect_new_glance, file = paste0("policyBrief_out/", "Table_regression_cycle_salesselect.xlsx"), sheet = "sales_glance", append = TRUE)
...
df_reg_US %>% filter(state_abb == "US") %>% 
	mutate(RGSP = GDP_FRED) %>%
	lm(nonPITsalestot_dlogcycle ~ GDP_dlogcycle + GDP_dlogcycle:after99, data = .) 
...
mod_other_GSPrecDummy <- 
	df_reg_US %>% filter(state_abb == "US") %>% 
	mutate(RGSP = GDP_FRED) %>%
	lm(nonPITsalestot_dlogcycle ~ GDP_dlogcycle + recession_recent2, data = .) 
...
write.xlsx2(Table_other_param,  file = paste0("policyBrief_out/", "Table_regression_cycle_other.xlsx"), sheet = "other_param" )
write.xlsx2(Table_other_glance, file = paste0("policyBrief_out/", "Table_regression_cycle_other.xlsx"), sheet = "other_glance", append = TRUE)
