...
df_sim %<>% 
	mutate(
		     ...
		     growthReal_taxGDP_a1      = taxGrowth_trend_1["taxGDP"] + taxGrowth_elastGDP_1["taxGDP"] * gdp_chg_cycle,
				 ...
				 growthReal_taxGDP_a2      = taxGrowth_trend_2["taxGDP"] + taxGrowth_elastGDP_2["taxGDP"] * gdp_chg_cycle
		      ) %>% 
	group_by(sim) %>% 
	mutate(gdpLevel = cumprod(1 + gdp_chg),
			...
			growthReal_tot_GDPState_a1   = ifelse(year  == 1, taxLevelReal_GDPState_tot_a1 - 1, taxLevelReal_GDPState_tot_a1/lag(taxLevelReal_GDPState_tot_a1) - 1),
			...
			growthReal_tot_GDPState_a2   = ifelse(year  == 1, taxLevelReal_GDPState_tot_a2 - 1, taxLevelReal_GDPState_tot_a2/lag(taxLevelReal_GDPState_tot_a2) - 1)
...
save(df_sim, file = paste0(dir_data_out, "GovFin_sim_forward.RData"))
...
ggsave(paste0(dir_fig_out, "fig_singleSim_tax_a1.png"), fig_singleSim_tax_a1, width = 10*0.8, height = 5*0.8)
...
ggsave(paste0(dir_fig_out, "fig_GovFin_taxGrowth_box_a1.png"), fig_taxGrowth_box_a1, width = 8*0.8, height = 7*0.8)
ggsave(paste0(dir_fig_out, "fig_GovFin_taxGrowth_box_a2.png"), fig_taxGrowth_box_a2, width = 8*0.8, height = 7*0.8)
...
ggsave(paste0(dir_fig_out, "fig_GovFin_taxLevel_PITState_a1.png"),   fig_taxLevel_PITState_a1, width = 8*0.8, height = 6*0.8)
ggsave(paste0(dir_fig_out, "fig_GovFin_taxLevel_salesState_a1.png"), fig_taxLevel_salesState_a1, width = 8*0.8, height = 6*0.8)
...
ggsave(paste0(dir_fig_out, "fig_GovFin_drop3pct_a1.png"),   fig_drop3pct_a1, width = 8*0.8, height = 8*0.8)
ggsave(paste0(dir_fig_out, "fig_GovFin_drop5pct_a1.png"),   fig_drop5pct_a1, width = 8*0.8, height = 8*0.8)
