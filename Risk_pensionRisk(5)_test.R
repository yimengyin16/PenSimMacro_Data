...
df_risk <- 
	...
	mutate(
		...
		ERC_tax_PITState_a1_high1   = cumany(ERC_tax_PITState_a1 >= ERC_tax_PITState_a1[year == 1] + 0.03 ),
		ERC_tax_PITState_a1_high2   = cumany(ERC_tax_PITState_a1 >= 0.12),
		ERC_tax_PITState_a1_hike    = cumany(na2zero(ERC_tax_PITState_a1 - lag(ERC_tax_PITState_a1, 2) >= 0.02)),

		ERC_tax_salesState_a1_high1 = cumany(ERC_tax_salesState_a1>= ERC_tax_salesState_a1[year == 1] + 0.03),
		ERC_tax_salesState_a1_high2 = cumany(ERC_tax_salesState_a1>= 0.12),
		ERC_tax_salesState_a1_hike  = cumany(na2zero(ERC_tax_salesState_a1 - lag(ERC_tax_salesState_a1, 2) >= 0.02)),

		ERC_tax_local_a1_high1 = cumany(ERC_tax_local_a1 >= ERC_tax_local_a1[year == 1] + 0.03),
		ERC_tax_local_a1_high2 = cumany(ERC_tax_local_a1 >= 0.12),
		ERC_tax_local_a1_hike  = cumany(na2zero(ERC_tax_local_a1 - lag(ERC_tax_local_a1, 2) >= 0.02)),
		
		ERC_tax_GDPState_a1_high1 = cumany(ERC_tax_GDPState_a1 >= ERC_tax_GDPState_a1[year == 1] + 0.03),
		ERC_tax_GDPState_a1_high2 = cumany(ERC_tax_GDPState_a1 >= 0.12),
		ERC_tax_GDPState_a1_hike  = cumany(na2zero(ERC_tax_GDPState_a1 - lag(ERC_tax_GDPState_a1, 2) >= 0.02))
...
write.xlsx2(Table_ERC_tax_high1,  file = paste0(dir_fig_out, "Table_RiskGov_ERC_tax_risk_sensitivityLow.xlsx"), sheetName = "ERC_tax_high1")
write.xlsx2(Table_ERC_tax_high2,  file = paste0(dir_fig_out, "Table_RiskGov_ERC_tax_risk_sensitivityLow.xlsx"), sheetName = "ERC_tax_high2", append = TRUE)
write.xlsx2(Table_ERC_tax_hike,   file = paste0(dir_fig_out, "Table_RiskGov_ERC_tax_risk_sensitivityLow.xlsx"), sheetName = "ERC_tax_hike" , append = TRUE)
