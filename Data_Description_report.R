...
ggsave(paste0(dir_techReport, "fig_stock.gdp.png"), fig_stock.gdp, width = 10*0.95, height = 5*0.95)
ggsave(paste0(dir_techReport, "fig_gbond.gdp.png"), fig_gbond.gdp, width = 10*0.95, height = 5*0.95)
ggsave(paste0(dir_techReport, "fig_corr_stock.gbond.png"), fig_corr_stock.gbond, width = 10*0.95, height = 5*0.95)
ggsave(paste0(dir_techReport, "fig_qqplot.png"), fig_qqplot, width = 10, height = 7)
...
write_excel_csv(df_stats, paste0(dir_techReport, 'descriptive_stats.csv') )

paste0(dir_techReport, 'descriptive_stats.csv')
