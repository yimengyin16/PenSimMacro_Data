...
ggsave(paste0(dir_fig_out, "fig_RiskGov_ERC_tax_high15.png"), fig_ERC_tax_high15, width = 8, height = 9 )
...
write.xlsx2(Table_ERC_tax_high2,  file = paste0(dir_fig_out, "Table_RiskGov_ERC_tax_risk.xlsx"), sheetName = "ERC_tax_high2")
write.xlsx2(Table_ERC_tax_high15, file = paste0(dir_fig_out, "Table_RiskGov_ERC_tax_risk.xlsx"), sheetName = "ERC_tax_high15", append = TRUE)
